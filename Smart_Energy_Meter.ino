...
#define API_KEY "AIzaSyAThgvytadvWISNOMDL7yPtjf9QTGe-WUs"
   // Insert RTDB URLefine the RTDB URL */
#define DATABASE_URL "https://smart-energy-meter-1207a-default-rtdb.firebaseio.com/" 
    /* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "smartenergymeter22@gmail.com"
#define USER_PASSWORD "SMARTenergymeter22"
...
//Meter_number
const String MeterNumber = "56429970"; 

Preferences preferences;

//LCD PIN Setup
const int rs = 25, en = 26, d4 = 27, d5 = 14, d6 = 22, d7 = 23;
...
//Credit Cal interval 
unsigned long lastCreditCalPrevMillis = 0;
...
//  pzem.reset();
  ...
  //Retrive Energy Unit..........................................................................................................
    ...
    MeterCredit = preferences.getFloat("credit", MeterCredit); 
      ...
      [](AsyncWebServerRequest *request, uint8_t *data, size_t len, size_t index, size_t total)
      {
       // Serial.println("3");
        Serial.println(String("data=") + (char*)data);
             ...
             // EnergyUnit = new_unit;
             //convert add amount to meter credit
              int NewMeterCredit = MeterCredit + amount;
              MeterCredit = NewMeterCredit;
              preferences.begin("meter_unit", false);
              preferences.putFloat("credit", MeterCredit); 
              preferences.end();
              request->send(200, "text/plain", "data Recieved!");
              delay(2000);
              // Restart ESP
...
void Usage(){
 ...
 unsigned long currentMillismeasurement = millis();
  ...
  //convert change in energy to money..............................
  float usedCredit = changeinEnergy / 1000 * billRate ;
  MeterCredit = MeterCredit - usedCredit;
  ...
  Serial.println(MeterCredit/billRate * 1000);
    // cal energy unit from metercredit balance
//    int Unit = MeterCredit/billRate * 1000;
      EnergyUnit = MeterCredit/billRate * 1000;
   
  //reclaculate Credit amount after consumtion...........................

  //convert unit to kwh = unit/1000
  //int credit = EnergyUnit / 1000 * billRate ;
  //MeterCredit = credit;
...
void DisplayData(){
  // Print the custom address of the PZEM
    ...
    if(isnan(voltage)){
        ...
        lcd.setCursor(0,0);
        lcd.print("UNIT:");
        lcd.print(EnergyUnit,1);
        lcd.print("WH");
   //interval dislay
   unsigned long currentMillisDisplay = millis();
   if(currentMillisDisplay - lastDisplayPrevMillis > 7000){
        lcd.setCursor(0,1);
        lcd.print("L-A:");
